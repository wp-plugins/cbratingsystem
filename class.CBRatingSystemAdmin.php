...
//				echo '</pre>';
                ...
                $formSavableData['hide_all_user_name']              = ( isset( $ratingFormData['hide_all_user_name'] ) and ( ( $ratingFormData['hide_all_user_name'] == 1 ) ) ) ? 1 : 0;
                $formSavableData['allow_user_to_hide']              = ( isset( $ratingFormData['allow_user_to_hide'] ) and ( ( $ratingFormData['allow_user_to_hide'] == 1 ) ) ) ? 1 : 0;
                $formSavableData['replace_wc_tab']                  = ( isset( $ratingFormData['replace_wc_tab'] ) and ( ( $ratingFormData['replace_wc_tab'] == 1 ) ) ) ? 1 : 0;
                $formSavableData['include_with_wpec']               = ( isset( $ratingFormData['include_with_wpec'] ) and ( ( $ratingFormData['include_with_wpec'] == 1 ) ) ) ? 1 : 0;
                $formSavableData['include_with_edd']                = ( isset( $ratingFormData['include_with_edd'] ) and ( ( $ratingFormData['include_with_edd'] == 1 ) ) ) ? 1 : 0;
	...
	public static function admin_ratingForm_edit_page( $ratingForm ) {
		...
		$output .= '
                                ...
                                <!-- 17-12-14-->
                                 <div class="form-item form-type-checkbox form-item-hide_all_user_name" id="hide_all_user_name">
                                    <input type="checkbox" id="edit-hide_all_user_name" name="ratingForm[hide_all_user_name]" value="1" ' . ( ( $post['hide_all_user_name'] ) ? ( ( $post['hide_all_user_name'] == 1 ) ? 'checked ' : '' ) : ( ( $ratingForm->hide_all_user_name ) ? 'checked ' : ( ( $ratingForm->hide_all_user_name == '' || $ratingForm->hide_all_user_name == '0' ) ? '' : 'checked ' ) ) ) . 'class="form-checkbox">
                                    <label class="option" for="edit-hide_all_user_name">Hide All User Name In Review</label>
                                    <div class="description add_left_margin">This will hide all user name in review '.apply_filters("cbratingsystem_buddypress_description"," [This is for premium version only] ").' </div>
                                </div>
                                <div class="form-item form-type-checkbox form-item-allow_user_to_hide" id="allow_user_to_hide">
                                    <input type="checkbox" id="edit-allow_user_to_hide" name="ratingForm[allow_user_to_hide]" value="1" ' . ( ( $post['allow_user_to_hide'] ) ? ( ( $post['allow_user_to_hide'] == 1 ) ? 'checked ' : '' ) : ( ( $ratingForm->allow_user_to_hide ) ? 'checked ' : ( ( $ratingForm->allow_user_to_hide == '' || $ratingForm->allow_user_to_hide == '0' ) ? '' : 'checked ' ) ) ) . 'class="form-checkbox">
                                    <label class="option" for="edit-allow_user_to_hide">Allow User To Hide His/Her name</label>
                                    <div class="description add_left_margin">User can hide name while rating '.apply_filters("cbratingsystem_buddypress_description"," [This is for premium version only] ").' </div>
                                </div>
                                  <div class="form-item form-type-checkbox form-item-replace_wc_tab" id="replace_wc_tab">
                                    <input type="checkbox" id="edit-replace_wc_tab" name="ratingForm[replace_wc_tab]" value="1" ' . ( ( $post['replace_wc_tab'] ) ? ( ( $post['replace_wc_tab'] == 1 ) ? 'checked ' : '' ) : ( ( $ratingForm->replace_wc_tab ) ? 'checked ' : ( ( $ratingForm->replace_wc_tab == '' || $ratingForm->replace_wc_tab == '0' ) ? '' : 'checked ' ) ) ) . 'class="form-checkbox">
                                    <label class="option" for="edit-replace_wc_tab">Replace Woocommerce Review Tab</label>
                                    <div class="description add_left_margin">It will replace woocommerce default review tab '.apply_filters("cbratingsystem_buddypress_description"," [This is for premium version only] ").' </div>
                                </div>
                                 <!-- 17-12-14-->
                                   <!-- 18-12-14-->

                                 <div class="form-item form-type-checkbox form-item-include_with_wpec" id="include_with_wpec">
                                    <input type="checkbox" id="edit-include_with_wpec" name="ratingForm[include_with_wpec]" value="1" ' . ( ( $post['include_with_wpec'] ) ? ( ( $post['include_with_wpec'] == 1 ) ? 'checked ' : '' ) : ( ( $ratingForm->include_with_wpec ) ? 'checked ' : ( ( $ratingForm->include_with_wpec == '' || $ratingForm->include_with_wpec == '0' ) ? '' : 'checked ' ) ) ) . 'class="form-checkbox">
                                    <label class="option" for="edit-include_with_wpec">Include Into Wp-ecommerce Product</label>
                                    <div class="description add_left_margin">It will include form into  Wp-ecommerce single product page '.apply_filters("cbratingsystem_buddypress_description"," [This is for premium version only] ").' </div>
                                </div>
                                  <div class="form-item form-type-checkbox form-item-include_with_edd" id="include_with_edd">
                                    <input type="checkbox" id="edit-include_with_edd" name="ratingForm[include_with_edd]" value="1" ' . ( ( $post['include_with_edd'] ) ? ( ( $post['include_with_edd'] == 1 ) ? 'checked ' : '' ) : ( ( $ratingForm->include_with_edd ) ? 'checked ' : ( ( $ratingForm->include_with_edd == '' || $ratingForm->include_with_edd == '0' ) ? '' : 'checked ' ) ) ) . 'class="form-checkbox">
                                    <label class="option" for="edit-include_with_edd">Include Into Easy Digital Download Product</label>
                                    <div class="description add_left_margin">It will include form into Easy Digital Download single product page '.apply_filters("cbratingsystem_buddypress_description"," [This is for premium version only] ").' </div>
                                </div>
